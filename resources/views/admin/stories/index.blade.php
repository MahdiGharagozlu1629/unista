            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <span class="badge badge-primary px-3 py-2">مجموع: {{ $stories->total() }} استوری</span>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="d-flex justify-content-center align-items-center">
                                            ...
                                            @endif
                                            <form action="{{ route('admin.stories.destroy', ['story' => $story->id]) }}" method="post" class="m-0">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="btn btn-sm btn-outline-danger ml-2 delete-story-btn d-flex align-items-center" title="حذف استوری">
